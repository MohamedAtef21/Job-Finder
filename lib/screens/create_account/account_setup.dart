...
class AccountSetupView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        padding: const EdgeInsetsDirectional.only(start: 25,top: 97,end: 25),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.center,
          children: [
            Image.asset("assets/images/acc_setup.png",height: 142.h,width: 173.w,),
            SizedBox(height: 24.h,),
            const Text("Your account has been set up!",style: TextStyle(fontSize: 24,fontFamily: "SF",fontWeight: FontWeight.w500,color: Color(0xff111827)),),
            SizedBox(height: 8.h,),
