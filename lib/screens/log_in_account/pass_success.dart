...
class PassSuccessView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Padding(
        padding: EdgeInsetsDirectional.only(start: 25,top: 196,end: 25),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.center,
          children: [
            Image.asset("assets/images/pass_changed.png",height: 142.h,width: 173.w,),
            SizedBox(height: 24.h,),
            Text("Password changed succesfully!",style: TextStyle(fontSize: 24,fontFamily: "SF",fontWeight: FontWeight.w500,color: Color(0xff111827)),),
