...
class CheckYourEmailView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Padding(
        padding: EdgeInsetsDirectional.only(start: 25,top: 204,end: 25),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.center,
          children: [
            Image.asset("assets/images/email_check.png",height: 142.h,width: 173.w,),
            SizedBox(height: 24.h,),
            Text("Check your Email",style: TextStyle(fontSize: 24,fontFamily: "SF",fontWeight: FontWeight.w500,color: Color(0xff111827)),),
            SizedBox(height: 8.h,),
            ...
            ButtonView(textInput: "Open email app", onClick: (){
              navigateTo(context, CreateYourPassView());
            }),
          ],
        ),
      ),
