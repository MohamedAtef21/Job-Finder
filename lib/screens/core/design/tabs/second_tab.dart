    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          const Text("Contact Us",style: TextStyle(fontSize: 14,fontFamily: "SF",fontWeight: FontWeight.w500,),),
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      const Text("Email",style: TextStyle(fontSize: 12,fontFamily: "SF",fontWeight: FontWeight.w400,color: Color(0xff9CA3AF,)),),
                      SizedBox(height: 2.h,),
                      const Text("twitter@mail.com",style: TextStyle(fontSize: 14,fontFamily: "SF",fontWeight: FontWeight.w500,),)
                    ],
                  ),
                ),
              ),
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      const Text("Website",style: TextStyle(fontSize: 12,fontFamily: "SF",fontWeight: FontWeight.w400,color: Color(0xff9CA3AF,)),),
                      SizedBox(height: 2.h,),
                      const Text("https://twitter.com",style: TextStyle(fontSize: 14,fontFamily: "SF",fontWeight: FontWeight.w500,),)
                    ],
                  ),
                ),
              ),
          ...
          SizedBox(height: 24.h),
          const Text("About Company",style: TextStyle(fontSize: 14,fontFamily: "SF",fontWeight: FontWeight.w500,),),
